...
import { getPopularMovies, img } from '../lib/tmdb';
...
export default function MoviesPage() {
  ...
  useEffect(() => {
    ...
    getPopularMovies().then(r => setMovies(r.results || [])).catch(() => setMovies([]));
  }, [settings.tmdbKey]);

  return (
    <div className="page" style={{ paddingTop: '1.5rem' }}>
      <h2 className="section-title" style={{ padding: '0 2rem' }}>🎬 Movies</h2>
